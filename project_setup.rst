...
* The ``tests`` folder contains:
  ...
  - Example tests that you should replace with your own meaningful tests (file: ``test_image_retrieval``)
...
* For convenience, the package version is stored in a single place: ``image_retrieval/__version__.py``. For updating the version number, you only have to change this file.
