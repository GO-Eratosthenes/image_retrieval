...
#. use the search functionality `here <https://github.com/GO-Eratosthenes/image_retrieval/issues>`__ to see if someone already filed the same issue;
...
#. `push <http://rogerdudler.github.io/git-guide/>`_ your feature branch to (your fork of) the image_retrieval repository on GitHub;
